  ...
  },
  {
    ...
    movies: [
      ...
      },
      {
        ...
        runtime: "90 min",
        genre: ["Animation", "Biography", "Drama", "History", "Mystery", "War"],
        director: "Ari Folman",
        writer: "Ari Folman",
...
function App() {
  ...
  const filteredMovies = movieData
    ...
    .filter(searchMoviesByTitle);
  // Function to populate genre options for the filter
